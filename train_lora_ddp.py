...
class TrainingArguments(transformers.TrainingArguments):
    ...
    lora_r: int = 64
    lora_alpha: int = 64            # scale每次更新对原linear层的影响程度
    ...
    gradient_accumulation_steps: int = 16  # per_device_train_batch_size * gradient_accumulation_steps should be 128
    ...
    for epoch in range(training_args.num_train_epochs):
        for step, batch in enumerate(train_loader):
            ...
            if step % training_args.gradient_accumulation_steps == 0:
                ...
                if is_master():
                    loss_item_avg = loss_item_avg / WORLD_SIZE
...
if __name__ == '__main__':
    print('lccccc', RANK)
    setup_ddp_envs(seed=123456 + RANK)
    print('ws', WORLD_SIZE)
    ...
    train_loader, _ = build_dataloader(data_args, training_args, tokenizer, dist=WORLD_SIZE > 1)
    ...
    """
    python -m torch.distributed.run --nproc_per_node 2 --nnodes 1 /home/chaofeng/workhome/chaofeng/llava_finetune/train_lora_ddp.py
    """